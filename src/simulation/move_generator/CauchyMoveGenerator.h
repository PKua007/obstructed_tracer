...
public:
    ...
    /**
     * @brief `__Host__ __device__` constructor, which initializes the generators using seeds generated by byte
     ...
     */
    CUDA_HOSTDEV CauchyMoveGenerator(float width, float integrationStep, unsigned int seed,
                                     size_t numberOfTrajectories);
